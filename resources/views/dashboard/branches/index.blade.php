    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('branches') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/dashboard">{{ __('Home') }}</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="#">{{ __('branches') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="card">
                        <div style="width: 100%; height: 200px; overflow: hidden; object-fit: cover">
                            <img class="card-img-top" src="{{ asset('storage/' . $branch->image) }}" alt="Card image cap"
                                style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <div class="card-body">
                            <h4 class="card-title">{{ $branch->branch_name }}</h4>
                            {{-- <p class="card-text">
                            ...
                            <button onclick="delete_item({{ $branch->id }})" class="btn btn-outline-danger waves-effect">
                                <i class="fa-solid fa-trash-can"></i>
                            </button>
                            <form id="delete-form-{{ $branch->id }}" {{-- action="{{dd($branch->id)}}" --}}
