    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('Video') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/dashboard">{{ __('Home') }}</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="#">{{ __('Video') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            @foreach ($videos as $video)
                @if ($video->evaluation == 'width')
                    <div class="col-md-4 col-lg-3">
                        <div class="card">
                            <div class="d-flex justify-content-center align-items-center p-1 video-width">
                            ...
                            Some quick example text to build on the card title and make up the bulk of the card's content.
                                ...
                                <button onclick="delete_item({{ $video->id }})"
        ...
        <div class="row match-height">
            ...
            @foreach ($videos as $video)
                @if ($video->evaluation == 'height')
                    <div class="col-md-4 col-lg-3">
                        <div class="card">
                            <div class="d-flex justify-content-center align-items-center p-1 video-height">
                                <video class="card-img" src="{{ asset('storage/' . $video->video) }}" controls
                                    style="width: 100%; height: 100%; object-fit: cover;">
                                    Your browser does not support the video tag.
                                </video>
