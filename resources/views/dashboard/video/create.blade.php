    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('Create Video') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">{{ __('Create Video') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="col-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Create Video') }}</h4>
                    </div>
                    <div class="card-body">
                        <form class="form" action="{{ route('video.store') }}" method="POST"
                            ...
                            <div class=" col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <select name="evaluation" id="evaluation" class="form-select">
                                        <option value="">{{ __('Choose View') }}</option>
                            ...
                            <div class=" col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="image">{{ __('Video Path') }}</label>
