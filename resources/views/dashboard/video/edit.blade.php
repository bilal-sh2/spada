    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('Edit Video') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/dashboard">{{ __('Home') }}</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{route('article.index')}}">{{ __('Videos') }}</a>
                            </li>
                            <li class="breadcrumb-item active"><a href="#">{{ __('Edit Video') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row  justify-content-center">
            <div class="col-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" action="{{ route('video.update' , $video->id ) }}" method="POST"
                            ...
                            <div class=" col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-column">{{ __('Video Name') }}</label>
                                    <input type="text" id="first-name-column" class="form-control" placeholder="Name"
                                        name="name" value="{{ $video->name }}">
                                </div>
                            </div>
                            <div class=" col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-column_ar">{{ __('Video Name (Arabic)') }}</label>
                                    <input type="text" id="first-name-column_ar" class="form-control" placeholder="عنوان الفيديو بالعربي ..."
                                        name="name_ar" value="{{ $video->name_ar }}">
                                </div>
                            </div>
                            {{-- <div class=" col-md-8 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="description">{{ __('Video Description') }}</label>
                            ...
                            <div class=" col-md-8 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="description_ar">{{ __('Video Description (Arabic)') }}</label>
                                    <textarea class="form-control" id="description_ar" rows="3" placeholder="وصف الفيديو بالعربي ..." name="description_ar"
                                        >{{ $video->description_ar }}</textarea>
                                </div>
                            </div> --}}
                            <div class=" col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <select name="evaluation" id="evaluation" class="form-select">
                                        <option value="{{$video->evaluation}}">{{$video->evaluation}}</option>
                            ...
                            <div class=" col-12">
                                <div class="mb-1" dir="ltr">
                                    ...
                                    <input type="hidden" name="description" id="description" value="{{ $video->description }}">
                                </div>
                            </div>
                            ...
                            <div class=" col-12">
                                <div class="mb-1" dir="ltr">
                                    ...
                                    <input type="hidden" name="description_ar" id="description_ar" value="{{ $video->description_ar }}">
                                </div>
                            </div>
                            ...
                            <div class=" col-md-6 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="video">{{ __('Video Path') }}</label>
                                    <input type="file" id="video" class="form-control" placeholder="Name"
