                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">{{ __('Create Product') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class=" col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control" id="description_ar" rows="3" placeholder="وصف المنتج بالعربي ..."
                                            name="description_ar" value="{{ old('description_ar') }}"></textarea>
                                    </div>
                                </div> --}}
                                ...
                                {{-- <div class=" col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <textarea class="form-control" id="use_method" rows="3" placeholder="Method used ..." name="use_method"></textarea>
                                    </div>
                                </div>
                                <div class=" col-md-6 col-12">
                                    <div class="mb-1">
