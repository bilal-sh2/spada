                    ...
                    <div class="card-body">
                        <form class="form" action="{{ route('category.store') }}" method="POST"
                            ...
                            <div class=" col-md-6 col-12">
                                ...
                                <div class="mb-1">
                                    <label class="form-label" for="first-name-column">{{ __('Category Name (Arabic)') }}</label>
                                    <input type="text" id="first-name-column" class="form-control" placeholder="الاسم باللغة العربية"
                                        name="category_name_ar" value="{{ old('category_name_ar') }}">
                                </div>
                            </div>
{{-- 
                            ...
                            <div class=" col-md-8 col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="description">{{ __('Category Description (Arabic)') }}</label>
                                    <textarea class="form-control" id="description" rows="3" placeholder=" اضافة الوصف باللغة العربية ..." name="description_ar"
