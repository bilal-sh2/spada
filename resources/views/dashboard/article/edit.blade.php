    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('Edit Article') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">{{ __('Edit Article') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row  justify-content-center">
            <div class="col-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form" action="{{ route('article.update' , $article->id ) }}" method="POST"
                            ...
                            <div class=" col-md-6 col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="first-name-column_ar" class="form-control" placeholder="عنوان المقالة بالعربي ..."
                                        name="name_ar" value="{{ $article->name_ar }}">
                                </div>
                            </div>
                            ...
                            <div class=" col-md-8 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="description_ar" rows="3" placeholder="وصف المقالة بالعربي ..." name="description_ar"
                                        >{{ $article->description_ar }}</textarea>
                                </div>
                            </div> --}}
                            ...
                            <div class=" col-12">
                                <div class="mb-1" dir="ltr">
                                    ...
                                    <input type="hidden" name="description" id="description" value="{{ $article->description }}">
                                </div>
                            </div>
                            ...
                            <div class=" col-12">
                                <div class="mb-1" dir="ltr">
                                    ...
                                    <input type="hidden" name="description_ar" id="description_ar" value="{{ $article->description_ar }}">
                                </div>
                            </div>
