    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('Show Article') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="#">{{ __('Show Article') }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('Show Article') }}</h4>
                    </div>
                    <div class="card-body">
                        <div>
                            <img class="card-img-top" src="{{ asset('storage/' . $article->image) }}" alt="Card image cap" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                        <div class="card-body">
                            <div dir="ltr">
                                ...
                                <div dir="ltr" class="card-text">
                                    {!! $article->description !!}
                                </div>
                            </div>
                            <div dir="rtl">
                                <h4 class="card-title">{{ __('Title (Arabic)') }}</h4>
                                <h4 class="card-title">{{$article->name_ar}}</h4>
                            ...
                            <a href="{{ route('article.edit', $article->id) }}" class="btn btn-outline-warning waves-effect">
